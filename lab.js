...
const favoriteThings = {
  ...
  person: "Spouse",
  book: "History",
  movie: "The Pirates of Carribean",
  holiday: "New Year"
}
...
const vasya = new Cat("Vasya", 4, "grey")
...
const roland = new Wizard("Ryland", 45, "Resurrection")
roland.castSpell()
...
//Code Here
let iphone = new Phone('Iphone', '11', 64, "black", 900)
let samsung = new Phone ("Samsung", "Note", 128, "white", 1000)
let nokia = new Phone ("Nokia", "2310", 2, "silver", 150) 
...
//Code Here
let myFirstVehicle = new Vehicle(5, "green", 0)
...
//Code Here 
let yamaha = new Motorcycle(2, "white", 5, "Yamaha", true)
...
class Boat extends Vehicle {
  ...
  checkSeaworthiness() {
    this.isSeaworthy ? console.log(`THe ${this.color} ${this.type} is seaworthy!`) : console.log(`You \
need to get your ${this.type} in shape!`)
  }
  performMaintenance() {
...
//Code Here
let myFirstBoat = new Boat(10, "white", 500, "Pobeda", "power", false) 
